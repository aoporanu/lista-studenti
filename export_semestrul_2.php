...
WHERE
    u.id = "' . $_SESSION['user']['user_id'] . '" AND c.semestru = "2"';
...
$pdf->SetHeaderData(0, 0, ' Export examene ' . $nume_prof . ' semestrul 2', '', array(0,64,255), array(0,64,128));
...
$pdf->Output('export_examene_' . $nume_prof . '.pdf');
        ...
        {
            echo '<div class="alert alert-warning">Nu aveti programate examene pentru semestrul 2</div>';
        }
